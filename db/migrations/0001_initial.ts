...
/**
 * Baseline: mismo DDL que corría inline en db/client.ts antes de que existiera
 * schema_version (ver docs/04_base_datos.md). Usa CREATE TABLE/INDEX IF NOT EXISTS
 * a propósito: en una instalación que ya tenía estas tablas, correr esto es un
 * no-op y la migración solo deja el registro en schema_version.
 */
